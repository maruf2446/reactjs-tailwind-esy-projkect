            ...
            <div className='max-w[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
                ...
                <div className='flex justify-center items-center'>
                    ...
                    <Typed className='md:text-5xl sm:text-4xl text-xl font-bold md:pl-4 pl-2'
                        strings={['Maruf', 'Nobin', 'Nebir',]}
                        typeSpedd={120}
                        backSpeed={140}
                        loop
                    ></Typed>
                </div>
                <p className='md:text-2xl text-xl font-bold text-gray-500'>Monitor your data analytics to increase revenue for Maruf, Nobin, && Nebir platforms.</p>
